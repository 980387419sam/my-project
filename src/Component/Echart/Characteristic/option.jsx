        ...
        setTimeout(() => {
          ...
          if (m % 2 === 0) {
            ...
            if (((m / 2) | 0) % 2 === 0) {
              ...
              for (let i = 0; i < 4; i += 1) {
                option.series[7].data.push(Math.random() * 0.6)
                option.series[8].data.push(Math.random() * 0.6)
                option.series[9].data.push(Math.random() * 0.6)
                option.series[10].data.push(Math.random() * 0.6)
              }
            }
            before = position
          }
